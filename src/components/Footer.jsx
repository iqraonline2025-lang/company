        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-24 items-center">
          ...
          >
            ...
            <form onSubmit={handleSubscribe} className="relative group">
              ...
              <button
                type="submit"
                className="absolute right-2 top-2 bottom-2 px-4 bg-white text-black rounded-xl hover:bg-purple-500 hover:text-white transition-all duration-300 active:scale-95 flex items-center justify-center"
              >
                <Send size={18} />
              </button>
            </form>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 pb-20 border-b border-white/5">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                { Icon: Facebook, url: "https://www.facebook.com/profile.php?id=61579509960287" },
                { Icon: Instagram, url: "#" },
                { Icon: Twitter, url: "#" },
                { Icon: Linkedin, url: "https://www.linkedin.com/in/iqra-online-abb265393/" }
              ].map((item, idx) => (
                <a 
                  key={idx} 
                  href={item.url} 
                  ...
                  className="p-4 bg-white/5 rounded-2xl border border-white/5 text-gray-400 hover:text-white hover:border-purple-500/50 hover:-translate-y-1 transition-all duration-300"
                >
                  <item.Icon size={20} />
                </a>
              ))}
          ...
          {[
            ...
            <div key={idx}>
              ...
              <ul className="space-y-4">
                {col.links.map((link) => (
                  <li key={link}>
                    <Link to="#" className="text-gray-400 hover:text-purple-400 font-light transition-colors duration-300 text-sm">
                      {link}
                    </Link>
                  </li>
                ))}
