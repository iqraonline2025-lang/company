...
export default function Navbar() {
  ...
  // Check Auth Status (Logic from Version 2)
  useEffect(() => {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 w-full z-[100] transition-all duration-700 ${
        scrolled 
          ? "py-3 bg-white/80 backdrop-blur-2xl shadow-[0_10px_40px_rgba(0,0,0,0.08)] border-b border-white/20" 
          : "py-6 bg-transparent"
      }`}
    >
          ...
          >
            <div className="p-8 space-y-8">
              ...
              <div className="pt-8 border-t border-gray-100 flex justify-between items-center">
                ...
                {isLoggedIn && (
                  <button onClick={handleLogout} className="text-red-500 font-bold text-xs uppercase tracking-widest">
                    Logout
                  </button>
                )}
              </div>
